...
namespace Test.Web.Controllers
{
    ...
    public class StupidSortController : Controller
    {
        IDataService db;
        ISortStrategy sorting;

        public StupidSortController(IDataService dservice, StupidSorting sorting)
        {
            this.db = dservice;
            this.sorting = sorting;
        }

        // GET api/StupidSort?length=15&isascending=false
        [HttpGet]
